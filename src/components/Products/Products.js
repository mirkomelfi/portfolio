export const products=[
{
    ...
    description:"Ecommerce basico de venta de productos. Hay registro y loggueo de usuarios. Filtrado por categorias. Carrito de compras con Control de Stock. Integracion con MercadoPago. Al finalizar el carrito, se envia un mail automatico al usuario con el ticket y la compra efectuada",
